...
export default function AdminCard(){
    ...
    return(
        <><div><h1>Modelos de vehiculos disponibles</h1></div>
        <div>
            <h2>Hay un total de {cars} modelos de vehiculos existentes</h2>
        </div>

        <div><h1>Vehiculos para alquiler en stock</h1></div>
        <div>
            <h2>Hay un total de {totalStockCars} vehiculos disponibles en {locationAviable} agencias</h2>
        </div>
        ...
        <div><h1>Usuarios existentes</h1></div>
        <div>
