...
<Grid item xs={7}>
    ...
    <TableContainer component={Paper} style={{marginTop:'20px', marginBottom:'20px', border:'solid 1px lightgrey'}}>
      <Table aria-label="simple table" stickyHeader>
        <TableHead>
          <TableRow>
            <TableCell align="center" style={{color:'#1565C0', fontWeight:'bolder'}}>Id</TableCell>
            <TableCell align="center" style={{color:'#1565C0', fontWeight:'bolder'}}>Descripcion</TableCell>
