    ...
    <>
      ...
      <div className={styles.all}>
        ...
        <div className={styles.container}>
          <p>Versión vigente: 1 Junio, 2022</p>
          <h2>1- Carry</h2>
          <p>
            Carry es una compañía que ofrece servicios vinculados principalmente
          ...
          <p>
            ...
            momento en que se registran en el Sitio y usan la plataforma.
          </p>
          ...
          <p>
            ...
            la plataforma. En ningún caso afectarán las operaciones que ya hayan
            finalizado.
          </p>

          <p>
            Las Personas Usuarias que no tengan obligaciones pendientes con
            Carry o con otras Personas Usuarias, podrán finalizar la relación
            con Carry cancelando su cuenta.
          </p>

          <h2>3- Capacidad</h2>
          <p>
            Podrán usar nuestros servicios las personas mayores de edad que
            tengan capacidad legal para contratar y/o menores autorizados a
            conducir.{" "}
          </p>

          <p>
            Quien use la plataforma en representación de una empresa deberá
            tener capacidad para contratar a nombre de ella. Además, para poder
            usar la cuenta, la Persona Usuaria debe encontrarse activa.{" "}
          </p>
          ...
          <p>
            ...
            ella con la clave personal de seguridad que haya elegido y que
            deberá mantener bajo estricta confidencialidad. Por eso, la Persona
            Usuaria será la única responsable por las operaciones que se
            realicen en su cuenta. En caso de detectar un uso no autorizado de
            su cuenta,deberá notificar de forma inmediata y fehaciente a Carry.{" "}
          </p>
          <p>
            ...
            Personas Usuarias que hayan sido inhabilitadas previamente. Tampoco
            podrán registrarse quienes estén incluidos o relacionados a personas
            incluidas en listas nacionales o internacionales de sanciones.{" "}
          </p>
          <p>
            Además, en caso de detectar el uso de más de una cuenta, podremos
            aplicar retenciones, débitos y/o cualquier otra medida si
            consideramos que ese accionar puede perjudicar al resto de las
            personas que usan el Sitio o a Carry, más allá de las sanciones que
          ...
          <p>
            ...
            sanciones que se establezcan en las reglas de uso particulares de
            los servicios de Carry.{" "}
          </p>

          <h2>7- Responsabilidad</h2>
          <p>
            Carry será responsable por cualquier defecto en la prestación de su
          ...
          <h2>8- Tarifas</h2>
          <p>
            Carry podrá cobrar por sus servicios y la Persona Usuaria se
          ...
          <p>
            Carry y/o sus sociedades relacionadas son propietarias de todos los
            ...
            entre otros (“Propiedad Intelectual”) y se encuentran protegidos por
            leyes nacionales e internacionales.
          </p>
          <p>
            Aunque Carry otorga permiso para usar sus productos y servicios
            conforme a lo previsto en los Términos y Condiciones, esto no
            implica una autorización para usar su Propiedad Intelectual, excepto
            consentimiento previo y expreso de Carry y/o sus sociedades
            ...
            Intelectual de Carry de una manera que cause confusión en el público
            y deberán llevar a cabo su actividad comercial bajo una marca o
            nombre comercial propio y distintivo, que no resulte confundible con
            la marca Carry.
          </p>
          <p>
            ...
            crear bases de datos propias que incluyan en todo o en parte nuestro
            ...
            le cause perjuicio, daños o pérdidas a Carry y/o a sus sociedades
            relacionadas. La utilización de los productos y servicios de Carry
            ...
            exclusiva responsabilidad del usuario. En caso que una Persona
            Usuaria o cualquier publicación infrinja la Propiedad Intelectual de
            Carry o de terceros, Carry podrá remover dicha publicación total o
          ...
          <h2>10- Indemnidad</h2>
          <p>
            La Persona Usuaria mantendrá indemne a Carry y sus sociedades
            ...
            en el sitio web. En virtud de esa responsabilidad, podrán realizar
          ...
          <p>
            ...
            relacionados con estos Términos y Condiciones y con el uso del
            sitio, Carry S.R.L. con CUIT 30-70308853-4 establece como domicilio
