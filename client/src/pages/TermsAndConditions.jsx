    ...
    <div className={styles.all}>
      ...
      <div className={styles.container}>
        ...
        <p>
          ...
          para que las Personas Usuarias puedan revisarlas y seguir usando el la
          plataforma. En ningún caso afectarán las operaciones que ya hayan
          finalizado.
        </p>

        <p>
          Las Personas Usuarias que no tengan obligaciones pendientes con Carry
          o con otras Personas Usuarias, podrán finalizar la relación con Carry
        ...
        <p>
          ...
          Carry de una manera que cause confusión en el público y deberán llevar
          a cabo su actividad comercial bajo una marca o nombre comercial propio
          y distintivo, que no resulte confundible con la marca Carry.
        </p>
        <p>
          ...
          perjuicio, daños o pérdidas a Carry y/o a sus sociedades relacionadas.
          La utilización de los productos y servicios de Carry tampoco implica
          la autorización para usar propiedad intelectual de terceros que pueda
          estar involucrada, cuyo uso quedará bajo exclusiva responsabilidad del
          usuario. En caso que una Persona Usuaria o cualquier publicación
          infrinja la Propiedad Intelectual de Carry o de terceros, Carry podrá
          remover dicha publicación total o parcialmente, sancionar al usuario
          conforme a lo previsto en estos Términos y Condiciones y ejercer las
        ...
        <p>
          ...
          el sitio web. En virtud de esa responsabilidad, podrán realizar
        ...
        <p>
          ...
          MercadoLibre S.R.L. con CUIT 30-70308853-4 establece como domicilio
